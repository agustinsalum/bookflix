...
from .models import Usuario, Tarjeta,Perfil, Comentario, Calificacion, Editorial, Autor,Genero,Novedad,Precio,Libro,Capitulo, Busqueda, Favorito
...
class LibroAdmin (admin.ModelAdmin):
    ...
    list_display=("titulo","autor","trailer")
